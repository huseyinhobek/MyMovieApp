...
//  MyMovieApp
//
//  Created by Hüseyin HÖBEK on 7.11.2022.
//
...
final class MovieHomeController: UIViewController {
    ...
    private func drawDesign() {
        ...
        configureNavigationBar(largeTitleColor: .systemIndigo, backgroundColor: .white, tintColor: .black, title: "Top IMDB Movies", preferredLargeTitle: false)
